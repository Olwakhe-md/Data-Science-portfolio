...
I am a biochemistry graduate with a strong interest in:

🧬 Biological data analysis

🌱 Agricultural and plant science analytics

🤖 Machine learning for health and biotech

📊 Data cleaning, preprocessing, and modeling

This portfolio reflects my progression from beginner-level Python skills to advanced data science tools and machine learning techniques — all applied to real biological datasets.
...
Built custom features like pH_category and weight_grams

Generated basic visualizations (histograms, grouped bar charts)

Wrote a structured mini-report summarizing findings
...
String cleaning (plant names, descriptions)
...
Select, filter, join, aggregate

Clean messy tables with SQL
...
Publish professional, well-documented notebooks and reports
